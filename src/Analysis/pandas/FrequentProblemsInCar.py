...
failures_per_constructor_sorted = failures_per_constructor.sort_values(
    by="failure_proportion", ascending=False
)
...
def get_status_code_occurrences(status_code, manufacturer=None):
    ...
    filtered_data = status_counts_per_constructor[
        status_counts_per_constructor["statusId"] == status_code
    ]
